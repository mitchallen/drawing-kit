...
<p>
  ...
  <a href="https://github.com/users/mitchallen/packages/npm/package/pen-v2">
    <img src="https://img.shields.io/github/package-json/v/mitchallen/drawing-kit?filename=packages%2Fpen%2Fpackage.json&label=GitHub%20Packages" alt="Version">
  </a>
...
> `@mitchallen/pen-v2` continues `@mitchallen/pen`, which stays on GitHub Packages frozen at 0.3.1. It is developed in the [drawing-kit](https://github.com/mitchallen/drawing-kit) monorepo.
